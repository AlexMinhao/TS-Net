...
#    cmd = """srun -p x_cerebra --gres=gpu:1 nohup python -u run_financial_power.py --data ./dataset/electricity.txt --hidden-size {} --window_size 168  --num_concat 0 --lradj 1 --lr 0.009 --horizon 24 --kernel 5 --batch_size 16 --normalize 2 --model_name ele_I168_o24_c168_type1_lr9e-3_bs16_dp0.5_h{}_s2l3 > log/0501_ele_I168_o24_c168_type1_lr9e-3_bs16_dp0.5_h{}_s2l3.log 2>&1&""".format(v,v,v)
#    cmd = """srun -p vi_x_cerebra_meta --gres=gpu:1 nohup python -u run_financial_power.py --data ./dataset/exchange_rate.txt --hidden-size 0.125 --window_size 168 --lradj 1 --lr 5e-3 --num_concat 0 --horizon 24 --kernel 5 --batch_size {} --model_name ex_I168_o24_type1_lr5e-3_bs{}_dp0.5_c168_h0.125_-+_2s3l > log/0427_ex_I168_o24_type1_lr5e-3_bs4_dp0.5_h0.125_-+_2s3l.log 2>&1&""".format(v,v,v)
    cmd = """srun -p x_cerebra --gres=gpu:1 nohup python -u run_financial_power.py --data ./dataset/traffic.txt --hidden-size {} --normalize 2  --window_size 168 --num_concat 0 --lradj 1 --lr 5e-4 --horizon 24 --kernel 5 --batch_size 16  --model_name traf_I168_o24_type1_lr5e-4_bs16_dp0.25_h{}T_s2l3 > log/0501_traf_I168_o24_type1_lr5e-4_bs16_dp0.25_h{}T_s2l3.log 2>&1&""".format(v,v,v)
