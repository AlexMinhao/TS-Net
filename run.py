...
#    cmd = """srun -p x_cerebra  -w SH-IDC1-10-198-8-110 --gres=gpu:1 nohup python -u run_financial_power.py --data ./dataset/traffic.txt --hidden-size {} --normalize 2  --window_size 168 --num_concat 0 --lradj 1 --lr 5e-4 --horizon 24 --kernel 5 --batch_size 16  --model_name traf_I168_o24_type1_lr5e-4_bs16_dp0.25_h{}T_s2l3 > log/0501_traf_I168_o24_type1_lr5e-4_bs16_dp0.25_h{}T_s2l3.log 2>&1&""".format(v,v,v)
