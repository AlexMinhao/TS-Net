...
#    for j,k in enumerate(hid):
    cmd = """srun -p vi_x_cerebra_meta -w SH-IDC1-10-198-8-244 --gres=gpu:1 nohup python -u run_financial_power.py --data ./dataset/solar_AL.txt --positionalEcoding True --hidden-size 2 --model_mode Enco --single_step 0 --normalize 2 --window_size 168 --num_concat 0 --lradj 6 --lr 1e-4 --horizon {} --kernel 5 --batch_size 1024 --model_name so_I168_o24_type1_lr_bs1024_dp0.5_h2_norm2_s1l3_o{}_L1_outN_pos > log/0504_so_I168_o24_type1_lr_bs1024_dp0.5_norm2_h2_s1l3_o{}_outN_L1_pos.log 2>&1&""".format(v,v,v)
    #cmd = """srun -p x_cerebra -w SH-IDC1-10-198-8-147 --gres=gpu:1 nohup python -u run_financial_power.py --data ./dataset/exchange_rate.txt --epochs 150 --model_mode Enco --hidden-size 0.125 --window_size 168 --lradj 1 --lr 5e-3 --horizon {} --kernel 5 --normalize 2 --batch_size 4 --model_name ex_I168_o{}_type1_lr5e-3_bs4_dp0.5_h0.125_1stack3layer_norm2_o > log/0428_ex_I168_o{}_type1_lr5e-3_bs4_dp0.5_h0.125_1stack3layer_norm2_o.log 2>&1&""".format(v,v,v)
